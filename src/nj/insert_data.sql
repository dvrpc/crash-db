...
begin
    ...
    elseif year_int >= 2017 and year_int <= 2022 then 
        ...
        elseif db_table = 'driver' then
            -- 2021-2022 not to spec, use null for DOB
    ...
    elseif year_int >= 2023 then
        ...
        elseif db_table = 'driver' then
            -- 2023 not to spec, use null for DOB
            execute format($q2$insert into temp_%1$s_%2$s values (
                nullif(trim(substring(%3$s from 1 for 4)), ''),    -- year
                nullif(trim(substring(%3$s from 5 for 4)), ''),    -- ncic (county & muni) code
                nullif(trim(substring(%3$s from 9 for 23)), ''),   -- dept case no
        ...
        elseif db_table = 'vehicle' then
            -- 2023 not to spec:
            --  - model occupies 75-104 rather than 75-94 in spec (and also is truncated)
            --  - usdot/other supposed to have length of 9, but has 1
            execute format($q2$insert into temp_%1$s_%2$s values (
                nullif(trim(substring(%3$s from 1 for 4)), ''),    -- year
                nullif(trim(substring(%3$s from 5 for 4)), ''),    -- ncic (county & muni) code
                nullif(trim(substring(%3$s from 9 for 23)), ''),   -- dept case no
                ...
                nullif(trim(substring(%3$s from 41 for 2)), ''),   -- owner state
                nullif(trim(substring(%3$s from 44 for 30)), ''),  -- make of vehicle
                nullif(trim(substring(%3$s from 75 for 30)), ''),  -- model of vehicle
                nullif(trim(substring(%3$s from 106 for 3)), ''),  -- color of vehicle
                nullif(trim(substring(%3$s from 110 for 4)), ''),  -- year of vehicle
                nullif(trim(substring(%3$s from 115 for 2)), ''),  -- license plate state
                nullif(trim(substring(%3$s from 118 for 1)), ''),  -- vehicle weight rating
                nullif(trim(substring(%3$s from 120 for 1)), ''),  -- towed
                nullif(trim(substring(%3$s from 122 for 2)), ''),  -- removed by
                nullif(trim(substring(%3$s from 125 for 1)), ''),  -- driven/left/towed
                nullif(trim(substring(%3$s from 127 for 2)), ''),  -- initial impact location
                nullif(trim(substring(%3$s from 130 for 2)), ''),  -- principal impact location
                nullif(trim(substring(%3$s from 133 for 2)), ''),  -- extent of damage
                nullif(trim(substring(%3$s from 136 for 2)), ''),  -- traffic controls present
                nullif(trim(substring(%3$s from 139 for 2)), ''),  -- vehicle type
                nullif(trim(substring(%3$s from 142 for 2)), ''),  -- vehicle use
                nullif(trim(substring(%3$s from 145 for 2)), ''),  -- special function veh
                nullif(trim(substring(%3$s from 148 for 2)), ''),  -- cargo body type
                nullif(trim(substring(%3$s from 151 for 2)), ''),  -- contrib circumstance 1
                nullif(trim(substring(%3$s from 154 for 2)), ''),  -- contrib circumstance 2
                nullif(trim(substring(%3$s from 157 for 2)), ''),  -- direction of travel
                nullif(trim(substring(%3$s from 160 for 2)), ''),  -- pre-crash action
                nullif(trim(substring(%3$s from 163 for 2)), ''),  -- first seq of events
                nullif(trim(substring(%3$s from 166 for 2)), ''),  -- second seq of events
                nullif(trim(substring(%3$s from 169 for 2)), ''),  -- third seq of events
                nullif(trim(substring(%3$s from 172 for 2)), ''),  -- fourth seq of events
                nullif(trim(substring(%3$s from 175 for 2)), ''),  -- most harmful event
                nullif(trim(substring(%3$s from 178 for 2)), ''),  -- oversize/overweight permit
                nullif(trim(substring(%3$s from 181 for 1)), ''),  -- hazmat status
                nullif(trim(substring(%3$s from 183 for 1)), ''),  -- hazmat class
                nullif(trim(substring(%3$s from 185 for 10)), ''), -- hazmat placard
                nullif(trim(substring(%3$s from 196 for 10)), ''), -- usdot number
                nullif(trim(substring(%3$s from 207 for 10)), ''), -- mc/mx number
                nullif(trim(substring(%3$s from 218 for 1)), ''),  -- usdot/other flag
                nullif(trim(substring(%3$s from 220 for 1)), ''),  -- usdot/other number
                nullif(trim(substring(%3$s from 222 for 50)), ''), -- carrier name
                nullif(trim(substring(%3$s from 273 for 1)), '')   -- hit & run driver flag
            )$q2$, db_table, year, quote_nullable(line));
        end if;
    end if;
end;
