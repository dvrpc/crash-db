...
from nj.all_crash c where c.collision_type = '00'

union all
select c.casenumber, 'collision_type', 'same_direction_rearend', 1
from nj.all_crash c where c.collision_type = '01'

union all
select c.casenumber, 'collision_type', 'same_direction_sideswippe', 1
from nj.all_crash c where c.collision_type = '02'

union all
select c.casenumber, 'collision_type', 'right_angle', 1
from nj.all_crash c where c.collision_type = '03'

union all
select c.casenumber, 'collision_type', 'opposite_direction_headon_angular', 1
from nj.all_crash c where c.collision_type = '04'

union all
select c.casenumber, 'collision_type', 'opposite_direction_sideswipe', 1
from nj.all_crash c where c.collision_type = '05'

union all
select c.casenumber, 'collision_type', 'struck_parked_vehicle', 1
from nj.all_crash c where c.collision_type = '06'

union all
select c.casenumber, 'collision_type', 'left_turn_u_turn', 1
from nj.all_crash c where c.collision_type = '07'

union all
select c.casenumber, 'collision_type', 'backing', 1
from nj.all_crash c where c.collision_type = '08'

union all
select c.casenumber, 'collision_type', 'encroachment', 1
from nj.all_crash c where c.collision_type = '09'

union all
select c.casenumber, 'collision_type', 'overturned', 1
from nj.all_crash c where c.collision_type = '10'

union all
select c.casenumber, 'collision_type', 'fixed_object', 1
from nj.all_crash c where c.collision_type = '11'

union all
select c.casenumber, 'collision_type', 'animal', 1
from nj.all_crash c where c.collision_type = '12'

union all
select c.casenumber, 'collision_type', 'pedestrian', 1
from nj.all_crash c where c.collision_type = '13'

union all
select c.casenumber, 'collision_type', 'pedalcyclist', 1
from nj.all_crash c where c.collision_type = '14'

union all
select c.casenumber, 'collision_type', 'non_fixed_object', 1
from nj.all_crash c where c.collision_type = '15'

union all
select c.casenumber, 'collision_type', 'railcar_vehicle', 1
from nj.all_crash c where c.collision_type = '16'


union all
select c.casenumber, 'collision_type', 'other', 1
from nj.all_crash c where c.collision_type = '99'
